...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " tweetcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  tweetcoin-tx [options] <hex-tx> [commands]  Update hex-encoded tweetcoin transaction\n" +
            "or:     tweetcoin-tx [options] -create [commands]   Create hex-encoded tweetcoin transaction\n" +
            "\n";
