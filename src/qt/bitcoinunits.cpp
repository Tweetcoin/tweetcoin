...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("TWTC");
    case mBTC: return QString("quacks");
    case uBTC: return QString("chirps");
    case SAT: return QString("tweetoshi");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Tweetcoins");
