Tweetcoin Core version *0.15.1* is now available from:

  <https://download.tweetcoin.us/tweetcoin-0.15.1/>
...
A number of changes to the way Tweetcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 quacks per kB (0.00001 TWTC). This is to prepare for dropping the minimum transaction fee to 0.1 quacks per kB (0.0001 TWTC) in the next release.
