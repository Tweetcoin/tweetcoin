...
"""Verify that starting tweetcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tweetcoin with -h for help text")
        ...
        self.log.info("Start tweetcoin with -version for version information")
        ...
        self.log.info("Start tweetcoind with -fakearg to make sure it does not start")
