...
bech32_templates = [
  ...
  ('twtc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('twtc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('twtc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('ttwtc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('ttwtc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('ttwtc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rtwtc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rtwtc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rtwtc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('ttwtc',  17, 32, False, False, False),
  ('rtwtc',  3,  1, False, False, False),
  ('twtc',   15, 41, False, False, False),
  ('ttwtc',  0, 16, False, False, False),
  ('rtwtc',  0, 32, True,  False, False),
  ('twtc',   0, 16, True,  False, False),
  ('ttwtc',  0, 32, False, True,  False),
  ('rtwtc',  0, 20, False, False, True)
]
